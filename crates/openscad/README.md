...
- :x: [`PI`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/General#Numbers) - mathematical constant [π](https://en.wikipedia.org/wiki/Pi) (~3.14159)
...
- :x: [`abs`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#abs)
...
- :x: [`acos`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#acos)
- :x: [`asin`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#asin)
- :x: [`atan`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#atan)
- :x: [`atan2`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#atan2)
- :x: [`floor`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#floor)
- :x: [`round`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#round)
- :x: [`ceil`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#ceil)
- :x: [`ln`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#ln)
...
- :x: [`log`](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Mathematical_Functions#log)
